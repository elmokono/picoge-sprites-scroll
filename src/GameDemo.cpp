...
void GameDemo::draw(void)
{
  ...
  if (player->playerPos.x + scrollX > 64) scrollX--;
  if (player->playerPos.x + scrollX < 32) scrollX++;
  if (player->playerPos.y + scrollY > 64) scrollY--;
  if (player->playerPos.y + scrollY < 32) scrollY++;
